...
/*
 * Returns success. TODO :: this should definitely not be in here, but moving it here for conversion of old conditions
 * task to scheduler task. Currently all the screen img logic is in this file too, it justfits nicer because it's just
 * an api call and flash save. Ideally all of the content-specific code would be it's only class, or maybe in the
 * http_client file.
 */
